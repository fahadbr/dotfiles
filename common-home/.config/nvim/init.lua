...
nmap('<C-S-=>', '5<C-w>+', 'increase vertical window size')
nmap('<C-S-->', '5<C-w>-', 'decrease vertical window size')
nmap('<C-S-,>', '5<C-w><', 'decrease horizontal window size')
nmap('<C-S-.>', '5<C-w>>', 'increase horizontal window size')
