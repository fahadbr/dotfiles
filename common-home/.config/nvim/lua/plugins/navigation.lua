...
return {
  -- harpoon {{{
  {
    ...
    config = function()
      ...
      fr.nmap('<space>ha', function()
        harpoon:list():add()
      end, 'add to harpoon list')
      fr.nmap('<space>hh', function()
        harpoon.ui:toggle_quick_menu(harpoon:list())
      end, 'show harpoon ui')

      for i = 0, 9 do
        local desc = string.format('Select harpoon list entry %d', i)
        local harpoonSelect = function()
      ...
      fr.nmap('<space>hp', function()
        harpoon:list():prev()
      end, 'Go to prev harpoon buffer')
      fr.nmap('<space>hn', function()
        harpoon:list():next()
...

  {
    ...
    cond = fr.in_kitty and not fr.in_tmux and not fr.in_herdr,
    init = function()
