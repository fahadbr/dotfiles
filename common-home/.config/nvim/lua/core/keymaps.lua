...
fr.nmap('<leader>TW', ':set wrap!<CR>', 'toggle line wrapping')
fr.nmap('<leader>sh', ':set hlsearch!<CR>', 'toggle search highlighting')
...
fr.imap_remap('<C-k>', '<C-o><C-k>', 'focus window north', true)
fr.imap_remap('<C-j>', '<C-o><C-j>', 'focus window south', true)
fr.imap_remap('<C-h>', '<C-o><C-h>', 'focus window west', true)
fr.imap_remap('<C-l>', '<C-o><C-l>', 'focus window east', true)
